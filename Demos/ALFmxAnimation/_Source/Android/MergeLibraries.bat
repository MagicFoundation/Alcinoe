...
set Libraries=%ALBaseDir%\Demos\ALAnimation\_Source\Android\App\
...
call "%ALBaseDir%\Tools\AndroidMerger\AndroidMerger.exe"^
 ...
 -Libraries="%Libraries%"^
 -OutputDir="%ALBaseDir%\Demos\ALAnimation\_Source\Android\Merged"^
 -DProj="%ALBaseDir%\Demos\ALAnimation\_Source\ALAnimationDemo.dproj"^
 -AndroidManifest="%ALBaseDir%\Demos\ALAnimation\_Source\AndroidManifest.template.xml"^

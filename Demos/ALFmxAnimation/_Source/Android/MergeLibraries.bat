...
set Libraries=%ALBaseDir%\Demos\ALFmxAnimation\_Source\Android\App\
...
call "%ALBaseDir%\Tools\AndroidMerger\AndroidMerger.exe"^
 ...
 -Libraries="%Libraries%"^
 -OutputDir="%ALBaseDir%\Demos\ALFmxAnimation\_Source\Android\Merged"^
 -DProj="%ALBaseDir%\Demos\ALFmxAnimation\_Source\ALFmxAnimationDemo.dproj"^
 -AndroidManifest="%ALBaseDir%\Demos\ALFmxAnimation\_Source\AndroidManifest.template.xml"^

...
begin
  try
    ...
    try
      ...
      var LDoneDir :=  ALGetModulePathW + '：done\';
      ...
      try
        ...
        for var Lfile in LFiles do begin
          TFile.Copy(Lfile, LdoneDir + ALExtractfilename(Lfile));
          var LPostJsonData := TALJsonDocumentA.CreateFromJSONFile(Lfile);
          //{
          //  "id":"4",
          //  "username":"cinema_streets",
          //  "profile_pic_url":"https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/connectwithchery.jpg",
          //  "geotag":"California",
          //  "caption":"https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/2023-12-26_20-20-28_UTC_1.jpg",
          //  "medias":[
          //    "https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/2023-12-26_20-20-28_UTC_1.jpg",
          //    "https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/2023-12-26_20-20-28_UTC_2.jpg",
          //    "https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/2023-12-26_20-20-28_UTC_3.jpg"],
              ...
              For var i := 0 to maxint do begin
                ...
                With addchild(TALJsonNodeType.ntObject) do begin
                  if LIsVideo then begin
                    ...
                    var LInputStream := TStringStream.Create;
                    var LOutputStream := TStringStream.Create;
                    try
                      ALWinExecW(
                        '"c:\Program Files\ffmpeg\bin\ffmpeg.exe" -i '+ALExtractfilename(LImgFilename)+' -vf "select=eq(n\,0)" -q:v 2 -frames:v 1 '+ALExtractfilename(LImgFilename, true{RemoveFileExt})+'.jpg', // const aCommandLine: String;
                        LdoneDir, // const aCurrentDirectory: String;
                    ...
                    //TFile.Copy(LImgFilename, LdoneDir + ALExtractfilename(LImgFilename));
                    AddChild('preview_url').Text := 'https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/' + ALExtractFileName(AnsiString(LImgFilename), true{RemoveFileExt})+'.jpg';
                    ...
                    TFile.Copy(LImgFilename, LdoneDir + ALExtractfilename(LImgFilename));
                    ResizeImageTo1080(LdoneDir + ALExtractfilename(LImgFilename));
                    AddChild('url').Text := 'https://www.magicfoundation.io/media/mockup/io.magicfoundation.alcinoe.alfmxdynamiclistboxdemo/' + ALExtractFileName(AnsiString(LImgFilename));
                    Var LBitmap := Tbitmap.create;
                    try

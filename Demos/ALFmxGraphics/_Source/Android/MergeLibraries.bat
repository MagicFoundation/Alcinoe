...
call "%ALBaseDir%\Tools\AndroidMerger\AndroidMerger.exe"^
 ...
 -Configurations="Debug;Debug_Skia;Debug_Skia_Vulkan;Debug_Skia_Metal;Debug_ALSkiaEngine;Debug_ALSkiaEngine_Vulkan;Debug_ALSkiaEngine_Metal;Debug_Metal;Debug_OpenGL;Release;Release_Skia;Release_Skia_Vulkan;Release_Skia_Metal;Release_ALSkiaEngine;Release_ALSkiaEngine_Vulkan;Release_ALSkiaEngine_Metal;Release_Metal;Release_OpenGL"^

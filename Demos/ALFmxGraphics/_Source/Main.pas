...
begin
  ...
  For var I := low(FScrollBoxDrawables) to high(FScrollBoxDrawables) do begin
    ...
    case i of
      ...
      02: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 0, 0);
      03: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 0, 0);
      04: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 25*ALGetScreenScale, 25*ALGetScreenScale);
      05: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 25*ALGetScreenScale, 25*ALGetScreenScale);
      06: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, min(W,h)/2, min(W,h)/2);
      07: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, min(W,h)/2, min(W,h)/2);
      08: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, 0, 0);
      09: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, 0, 0);
      10: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, min(W,h)/2, min(W,h)/2);
      11: FScrollBoxDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, min(W,h)/2, min(W,h)/2);
  ...
  For var I := low(FTestFPSDrawables) to high(FTestFPSDrawables) do begin
    ...
    {$ENDIF}
      ...
      case i mod 22 of
        ...
        02: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 0, 0);
        03: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 0, 0);
        04: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 25*ALGetScreenScale, 25*ALGetScreenScale);
        05: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, 25*ALGetScreenScale, 25*ALGetScreenScale);
        06: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, min(W,h)/2, min(W,h)/2);
        07: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 0, min(W,h)/2, min(W,h)/2);
        08: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, 0, 0);
        09: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, 0, 0);
        10: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscape', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, min(W,h)/2, min(W,h)/2);
        11: FTestFPSDrawables[i] := ALCreateDrawableFromResource('landscapelittle', nil, '', 1, W, H, False, TALImageWrapMode.Cover, TPointF.create(0.65, 0.48), TalphaColors.null, 5*ALGetScreenScale, min(W,h)/2, min(W,h)/2);

...
call "%ALBaseDir%\Tools\AndroidMerger\AndroidMerger.exe"^
 ...
 -Libraries="%Libraries%"^
 -OutputDir="%ALBaseDir%\Demos\ALFmxHttpWorker\_Source\Android\Merged"^
 -DProj="%ALBaseDir%\Demos\ALFmxHttpWorker\_Source\ALFmxHttpWorkerDemo.dproj"^
 -AndroidManifest="%ALBaseDir%\Demos\ALFmxHttpWorker\_Source\AndroidManifest.template.xml"^

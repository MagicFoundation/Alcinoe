...
set Libraries=%ALBaseDir%\Demos\ALFmxMediaPicker\_Source\Android\App\
...
call "%ALBaseDir%\Tools\AndroidMerger\AndroidMerger.exe"^
 ...
 -Libraries="%Libraries%"^
 -OutputDir="%ALBaseDir%\Demos\ALFmxMediaPicker\_Source\Android\Merged"^
 -DProj="%ALBaseDir%\Demos\ALFmxMediaPicker\_Source\ALFmxMediaPickerDemo.dproj"^
 -AndroidManifest="%ALBaseDir%\Demos\ALFmxMediaPicker\_Source\AndroidManifest.template.xml"^

...
{ TControl }
  ...
  public
    ...
    function AbsoluteToLocal(const Point: TPointF): TPointF; overload; virtual;
    ...
    function LocalToAbsolute(const Point: TPointF): TPointF; overload; virtual;
...
begin
  ...
  begin
    ...
    // Only for Update 2
    Field := SharedContext.GetType(ClassType).GetField('FIsPressed');
    if (Field <> nil) and Field.GetValue(Self).AsBoolean then
    begin

...
{ TCustomWebBrowserHelper }
                                                                                      

  TCustomWebBrowserHelper = class helper for TCustomWebBrowser
  public
...
procedure TCustomWebBrowserHelper.LoadFromStrings(const Content: string; const ContentEncoding: TEncoding; const BaseUrl: string);
var
  BrowserEx: ICustomBrowserEx;
begin
  if Supports(Self, ICustomBrowserEx, BrowserEx) then
    BrowserEx.LoadFromStrings(Content, ContentEncoding, BaseUrl)
  else
    LoadFromStrings(Content, BaseUrl);
end;

...
4) Build libbson + libmongoc (update 2.3.0 with your downloaded version)
------------------------------------------------------------------------

Notes:
- Replace BUILD_VERSION="2.3.0" with the version you downloaded.
- RelWithDebInfo is a good default for producing usable binaries with symbols.

---- win64:
   
   cmake -S c:\Dev\mongo-c-driver -B c:\Dev\mongo-c-driver\_build_x64 -D CMAKE_BUILD_TYPE=RelWithDebInfo -D BUILD_VERSION="2.3.0" -D ENABLE_MONGOC=OFF -D ENABLE_UNINSTALL=OFF -A x64
...
---- win32:
   ...
   cmake -S c:\Dev\mongo-c-driver -B c:\Dev\mongo-c-driver\_build_win32 -D CMAKE_BUILD_TYPE=RelWithDebInfo -D BUILD_VERSION="2.3.0" -D ENABLE_MONGOC=OFF -D ENABLE_UNINSTALL=OFF -A Win32

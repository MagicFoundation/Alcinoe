...
* [macOS/iOS: Inconsistent NSUserDefaultsClass.standardUserDefaults return type (macOS = Pointer, iOS = NSUserDefaults)](https://embt.atlassian.net/servicedesk/customer/portal/1/RSS-4389)
...
* [NSURL factory methods return types are inconsistent in D13 (fileURLWithPath returns NSURL, URLWithString returns Pointer)](https://embt.atlassian.net/servicedesk/customer/portal/1/RSS-4401)
...
* [iOS: Regression: UNUserNotificationCenter.setDelegate changed from UNUserNotificationCenterDelegate to Pointer](https://embt.atlassian.net/servicedesk/customer/portal/1/RSS-4344)

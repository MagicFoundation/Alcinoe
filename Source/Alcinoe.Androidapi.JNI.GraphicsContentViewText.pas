...
type
  ...
  {****************************************************}
  JALSoundEffectConstantsClass = interface(JObjectClass)
  ...
  JALSoundEffectConstants = interface(JObject)
    ['{584AACAC-7FE3-49D4-A748-069F28B515CB}']
  end;
  TJALSoundEffectConstants = class(TJavaGenericImport<JALSoundEffectConstantsClass, JALSoundEffectConstants>) end;
...
begin
  TRegTypes.RegisterType('Alcinoe.Androidapi.JNI.GraphicsContentViewText.JALSoundEffectConstants', TypeInfo(Alcinoe.Androidapi.JNI.GraphicsContentViewText.JALSoundEffectConstants));
end;

initialization
  {$IF defined(DEBUG)}
  ALLog('Alcinoe.Androidapi.JNI.GraphicsContentViewText','initialization');
  {$ENDIF}
  RegisterTypes;

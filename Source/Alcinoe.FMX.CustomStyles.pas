...
//initialization
//  TALStyleManager.Instance.AddOrSetEditStyle('MyCustomEditStyle', ALApplyMyCustomEditStyle, 16{ADefaultFontSize});
//  TALStyleManager.Instance.AddOrSetColor('MyCustomColor', $FFF5FA25, true{AIsForDarkMode});
//  TALStyleManager.Instance.AddOrSetColor('MyCustomColor', $FF12D2FF, False{AIsForDarkMode});

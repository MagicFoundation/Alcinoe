...
begin
  ...
  case FWrapMode of
    ...
    TALImageWrapMode.Cover: FRenderRect := FRenderRect.FitInto(LocalRect); // TALImageWrapMode.Cover not yet supported, use TALImageWrapMode.Fit instead
    else
...
{******************************************************************************************************************}
function TALBaseText.GetElementAtPos(const APos: TPointF; const AExpandTouchTarget: Boolean = True): TALTextElement;
begin

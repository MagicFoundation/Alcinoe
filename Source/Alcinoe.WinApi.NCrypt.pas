...
const NCRYPT_PKCS11_KWP_AES_KEY_BITS_PROPERTY = 'Pkcs11AesKeyBits';
const NCRYPT_PKCS11_KWP_OAEP_HASH_ALGO_PROPERTY = 'Pkcs11OaepHashAlgorithm';
const NCRYPT_PKCS11_KWP_OAEP_LABEL_PROPERTY = 'Pkcs11OaepLabel';

...
type
  ...
  public
    ...
    //procedure TearDown;
    [Test]
    procedure TestAlHTTPCookie;
    [Test]
    procedure TestALUtcDateTimeToRfc1123StrA;
    [Test]
    procedure TestALTryRfc822DateStrToUtcDateTime;
  end;
...
begin
  ...
  try
    ...
    Assert.AreEqual(TALHTTPCookie.MaxAgeUnset, Cookie.MaxAge, 'MaxAge should be 0');
    ...
    Assert.AreEqual(TALHTTPCookie.MaxAgeUnset, Cookie.MaxAge, 'MaxAge should be reset');
...
begin
  ...
  Assert.IsTrue(EndsStr('GMT', AnsiString(Result)), 'Test 2: Ends with GMT');
  ...
  Result := ALUtcDateTimeToRfc1123StrA(DateTime);
  Assert.IsTrue(EndsStr('GMT', AnsiString(Result)), 'Test 10: Non-UTC input ends with GMT');
...
{**************************************************************}
procedure TALDUnitXTestHttp.TestALTryRfc822DateStrToUtcDateTime;
var
  DateTime: TDateTime;
  Result: Boolean;

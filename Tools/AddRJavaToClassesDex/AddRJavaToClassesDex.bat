...
REM C:\Dev\MagicFoundation\Alcinoe\Tools\AddRJavaToClassesDex\AddRJavaToClassesDex.bat "$(PROJECTDIR)" "$(OUTPUTPATH)" "$(SDKAaptPath)" "$(SDKApiLevelPath)" "$(JavaDxPath)" "$(JDKPath)" true/false(true if you build an .aab package, false if you build an .apk)
REM 

  ...
  begin
    ...
    try
      ...
      if AXmlDoc.DocumentElement <> nil then begin
        Result := ALSameText(AXmlDoc.DocumentElement.NodeName, 'resources');
...
begin
  ...
  while ASrcNode.ChildNodes.Count > 0 do begin
    ...
    if (LSrcChildNode.NodeType = ntElement) then begin
      ...
      if ALSameText(ASrcNode.NodeName, 'manifest') and
         ALSameText(LSrcChildNode.NodeName, 'uses-sdk') then begin
      ...
      else if ALSameText(ASrcNode.NodeName, 'manifest') and
              ALSameText(LSrcChildNode.NodeName, 'uses-permission') then begin
        _SwapNodeToDest(
      ...
      //https://developer.android.com/guide/topics/manifest/permission-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'permission') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      //https://developer.android.com/guide/topics/manifest/queries-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'queries') then begin
      ...
      else if ALSameText(ASrcNode.NodeName, 'queries') and
              ALSameText(LSrcChildNode.NodeName, 'package') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      //https://developer.android.com/guide/topics/manifest/application-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'application') then begin
        if (LSrcChildNode.ChildNodes.Count = 0) and (LSrcChildNode.AttributeNodes.Count = 0) then continue;
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          '', // const aKeyAttributeName: AnsiString;
      ...
      else if (ALSameText(ASrcNode.NodeName, 'activity') or
               ALSameText(ASrcNode.NodeName, 'activity-alias') or
               ALSameText(ASrcNode.NodeName, 'application') or
               ALSameText(ASrcNode.NodeName, 'provider') or
               ALSameText(ASrcNode.NodeName, 'receiver') or
               ALSameText(ASrcNode.NodeName, 'service')) and
              ALSameText(LSrcChildNode.NodeName, 'meta-data') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      else if ALSameText(ASrcNode.NodeName, 'application') and
              ALSameText(LSrcChildNode.NodeName, 'activity') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      //https://developer.android.com/guide/topics/manifest/intent-filter-element
               ...
               ALSameText(ASrcNode.NodeName, 'activity-alias') or
               ALSameText(ASrcNode.NodeName, 'service') or
               ALSameText(ASrcNode.NodeName, 'receiver') or
               ALSameText(ASrcNode.NodeName, 'provider')) and
              ALSameText(LSrcChildNode.NodeName, 'intent-filter') then begin
      ...
      //https://developer.android.com/guide/topics/manifest/provider-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'provider') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      //https://developer.android.com/guide/topics/manifest/receiver-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'receiver') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
      ...
      //https://developer.android.com/guide/topics/manifest/service-element
              ...
              ALSameText(LSrcChildNode.NodeName, 'service') then begin
        _SwapNodeToDest(
          LSrcChildNode, // const ANode: TALXmlNode;
          'android:name', // const aKeyAttributeName: AnsiString;
          LSrcChildNode.Attributes['android:name']); // const aKeyAttributeValue: AnsiString;
    ...
    if (LInAutoGeneratedSection) or
      ...
      Try
        ...
        //we are in a disabled node
                ...
                (ALpos('!!',ALtrim(LChildNode.Text)) = 1) then begin
          ...
          LDisabledXmlSrc := ALStringReplace(LDisabledXmlSrc,'!!','',[rfReplaceALL]);
...
Begin
  Result := AlGetEnvironmentStringU;
  Var LEnvironmentLst := TALStringListU.Create;
  try
...
begin
  ...
  if LisAapt2 then begin
    LDebugRtxtDir := LDebugRtxtDir + ALExtractfilenameU(ALExcludeTrailingPathDelimiterU(ALibDir)) + '.R.txt';
    if Tfile.Exists(LDebugRtxtDir) then raise Exception.Create('Error EBDF9955-15D3-4B06-AD50-A02805834EE2');
  end
  else begin
    LDebugRtxtDir := LDebugRtxtDir + ALExtractfilenameU(ALExcludeTrailingPathDelimiterU(ALibDir));
  ...
  var LDebugRJavaOriginalFilename := LDebugRJavaFilename + ALExtractfilenameU(ALExcludeTrailingPathDelimiterU(ALibDir)) + '.R.java';
  if Tfile.Exists(LDebugRJavaOriginalFilename) then raise Exception.Create('Error C0110540-F418-42B3-8230-37314867DDC6');
  //var LDebugRJavaCompressedFilename := LDebugRJavaFilename + ALExtractfilenameU(ALExcludeTrailingPathDelimiterU(ALibDir)) + '.R.compressed.java';
  {$ENDIF}
  ...
  //if (LRTxt <> '') and
  //   (length(LRJavaSrc) - length(ALStringReplace(LRJavaSrc, ';', '', [RfIgnoreCase])) <> length(LRTxt) - length(ALStringReplace(LRTxt, #10, '', [RfIgnoreCase]))) then
...
begin
  ...
  if AVersionA = ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64) then begin
    ARelationship := 1;
    result := True;
    exit;
  end;
  if AVersionB = ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64) then begin
    ARelationship := -1;
    result := True;
    exit;
  end;
  ...
  if (LFlavorA <> '') and (LFlavorB <> '') and (LFlavorA = LFlavorB) then begin
    LVersionA := ALStringReplace(LVersionA, LFlavorA, '', []); //  31.1
    LVersionB := ALStringReplace(LVersionB, LFlavorB, '', []); //  27.2
  end;
  //---
  ...
  Result := True;
  //---
  var LVersionALst := TALstringList.Create;
  var LVersionBLst := TALstringList.Create;
  try
  ...
  try
    ...
    for var I := LLst.Count - 1 downto 0 do begin
      ...
      if LNumber = 0 then begin
        LLst[i] := ALinttostr(ALMaxint64);
        continue;
      end
      else begin
        LLst[i] := ALIntToStr(LNumber-1);
        break;
      end;
    end;
...
begin
  ...
  var LLocalFilenameWithoutExt := ALIncludeTrailingPathDelimiterU(ALocalRepositoryBaseDir) +
                                  ALStringReplaceU(string(AGroupId),'.','\',[RfReplaceALL]) + '\' +
                                  String(AArtifactId) + '\' +
                                  string(AVersion) + '\';
  ...
  if LPackaging <> '' then begin
    if ALSameText(LPackaging, 'pom') then ALocalArchivefilename := ''
  ...
  Try
    ...
    try
      ...
      if ALSameText(LPackaging, 'bundle') then LPackaging := 'jar';
...
begin
  ...
  if (aDependencyGroupId = 'com.google.guava') and (aDependencyArtifactId = 'guava') then
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, '-jre', '-android', []);

  //handle case la 3.+ => [3.0.0,)
  if alpos('+', LWorkDependencyVersionRequirements) > 0 then begin
    if (ALpos('[', LWorkDependencyVersionRequirements) > 0) or
       (ALpos(']', LWorkDependencyVersionRequirements) > 0) or
       (ALpos('(', LWorkDependencyVersionRequirements) > 0) or
       (ALpos(')', LWorkDependencyVersionRequirements) > 0) then raise Exception.Create('Error 90368DB2-6633-46E7-B3C0-115FC3857496');
    ...
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, '+', '.0', []); // 3.+ => 3..0
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, '..', '.', []); // 3..0 => 3.0
  ...
  try
    ...
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, ' ', '', [rfReplaceALL]);
    // 1.0 | [1.0] | 0.0.0.0,1.0] | [1.2,1.3] | [1.0,2.0) | [1.5,)        | 0.0.0.0,1.0],[1.2,)        | 0.0.0.0,1.1),(1.1,)
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, '(,', '0.0.0.0,', [rfReplaceALL]);
    // 1.0 | [1.0] | 0.0.0.0,1.0] | [1.2,1.3] | [1.0,2.0) | [1.5,<MAXINT> | 0.0.0.0,1.0],[1.2,<MAXINT> | 0.0.0.0,1.1),(1.1,<MAXINT>
    LWorkDependencyVersionRequirements := ALStringReplace(LWorkDependencyVersionRequirements, ',)', ',' + ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64), [rfReplaceALL]);
    ...
    if LLst.Count = 1 then begin
      ...
      // [1.0]
      if (ALpos('[', LStr) = 1) and
         (ALpos(']', LStr) = length(LStr)) then begin
        delete(LStr,1,1); // 1.0]
      ...
      // 1.0
        ...
        APreferredVersion := LStr; // 1.0
        Setlength(Result, 1);
        Result[0] := Tpair<AnsiString,AnsiString>.create('0.0.0.0', ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)+'.'+ALIntToStr(ALMaxInt64)); // 0.0.0.0 - maxint.maxint.maxint.maxint
      end;
      if (ALpos('[', APreferredVersion) > 0) or
         (ALpos(']', APreferredVersion) > 0) or
         (ALpos('(', APreferredVersion) > 0) or
         (ALpos(')', APreferredVersion) > 0) then raise Exception.Create('Error 73BA1C49-4E46-44A8-8A4D-118BC355889C');
    end
    ...
    // 0.0.0.0,1.0] | [1.2,1.3] | [1.0,2.0) | [1.5,<MAXINT> | 0.0.0.0,1.0],[1.2,<MAXINT> | 0.0.0.0,1.1),(1.1,<MAXINT>
      ...
      for var I := 0 to LLst.Count - 1 do begin
        ...
        //----
        // [1.2 | [1.0 | [1.5 | [1.2
        if (ALpos('[', LstrMin) = 1) then begin
          // 1.2 | 1.0 | 1.5 | 1.2
          delete(LstrMin,1,1);
          APreferredVersion := LstrMin;
        end
        // (1.1
        else if (ALpos('(', LstrMin) = 1) then begin
          // 1.1
          delete(LstrMin,1,1);
          // 1.1.1
        ...
        //----
        // 1.0] | 1.3] | 1.0]
        if (ALpos(']', LstrMax) = length(LstrMax)) then begin
          // 1.0 | 1.3 | 1.0
          delete(LstrMax,length(LstrMax),1);
          APreferredVersion := LstrMax;
        end
        // 2.0) | 1.1)
        else if (ALpos(')', LstrMax) = length(LstrMax)) then begin
          // 2.0 | 1.1
          delete(LstrMax,length(LstrMax),1);
          // 1.<MAXINT> | 1.0
        ...
        //----
        if (ALpos('[', LstrMin) > 0) or
           (ALpos(']', LstrMin) > 0) or
           (ALpos('(', LstrMin) > 0) or
           (ALpos(')', LstrMin) > 0) then raise Exception.Create('Error A8246244-77B7-4B2D-BDBA-12D9CAB5B4A1');
        //----
        if (ALpos('[', LstrMax) > 0) or
           (ALpos(']', LstrMax) > 0) or
           (ALpos('(', LstrMax) > 0) or
           (ALpos(')', LstrMax) > 0) then raise Exception.Create('Error 3BAB20BC-2DA5-458B-839A-08395B523FEE');
        //----
...
Function FindLibraryNode(
            const ALibraries: TALJsonDocument;
            const AGroupID: AnsiString;
            const AArtifactID: AnsiString;
...
Procedure ExpandPOM(const aPomXmlDoc: TalXmlDocument; const ALocalRepositoryBaseDir: String);
  ...
  begin
    ...
    for var I := 0 to LPropertiesNode.ChildNodes.Count - 1 do begin
      ...
      LXml := ALStringReplace(LXml, '${'+LPropertyNode.NodeName+'}', LPropertyNode.Text, [RfReplaceALL]);  // ${project.oauth.version} => 1.30.5
    end;
      ...
      if LdependencyManagementDependenciesNode <> nil then begin
        ...
        while not LDone do begin
          ...
          For var I := LdependencyManagementDependenciesNode.ChildNodes.Count - 1 downto 0 do begin
            ...
            if AlSameText(LImportScopeNode.Text, 'import') then begin
  ...
  try
    ...
    try
      ...
      Try
        ...
        JDKDir := ALIncludeTrailingPathDelimiterU(JDKDir);

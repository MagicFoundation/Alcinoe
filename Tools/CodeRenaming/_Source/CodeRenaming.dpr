...
begin
  ...
  try
    ...
    try
      ...
      LOldToNewNames.add('ALFmxFacebookCore=Alcinoe.FMX.FacebookCore');
      LOldToNewNames.add('ALFmxFacebookLogin=Alcinoe.FMX.FacebookLogin');
      LOldToNewNames.add('ALFmxFacebookShare=Alcinoe.FMX.FacebookShare');
      LOldToNewNames.add('ALFmxFilterEffects=Alcinoe.FMX.FilterEffects');
      LOldToNewNames.add('ALFmxFirebaseCore=Alcinoe.FMX.FirebaseCore');
      LOldToNewNames.add('ALFmxFirebaseMessaging=Alcinoe.FMX.FirebaseMessaging');

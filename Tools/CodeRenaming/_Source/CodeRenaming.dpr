...
begin
  ...
  try
    ...
    try
      ...
      LOldToNewNames.add('ALFitIntoAndCropAsMaskImageV1=ALLoadFromStreamAndFitIntoAndCropAndMaskToBitmap');
      LOldToNewNames.add('ALFitIntoAndCropAsMaskImageV2=ALLoadFromStreamAndFitIntoAndCropAndMaskToSkSurface');
      LOldToNewNames.add('ALFitIntoAndCropAsMaskImageV3=ALLoadFromStreamAndFitIntoAndCropAndMaskToDrawable');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsMaskImageV1=ALLoadFromStreamAndFitIntoAndCropAndMaskAndBlurToBitmap');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsMaskImageV2=ALLoadFromStreamAndFitIntoAndCropAndMaskAndBlurToSkSurface');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsMaskImageV3=ALLoadFromStreamAndFitIntoAndCropAndMaskAndBlurToDrawable');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsMaskImageV1=ALLoadFromResourceAndFitIntoAndCropAndMaskToBitmap');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsMaskImageV2=ALLoadFromResourceAndFitIntoAndCropAndMaskToSkSurface');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsMaskImageV3=ALLoadFromResourceAndFitIntoAndCropAndMaskToDrawable');
      LOldToNewNames.add('ALFitIntoAndCropAsRoundRectImageV1=ALLoadFromStreamAndFitIntoAndCropToRoundRectBitmap');
      LOldToNewNames.add('ALFitIntoAndCropAsRoundRectImageV2=ALLoadFromStreamAndFitIntoAndCropToRoundRectSkSurface');
      LOldToNewNames.add('ALFitIntoAndCropAsRoundRectImageV3=ALLoadFromStreamAndFitIntoAndCropToRoundRectDrawable');
      LOldToNewNames.add('ALFitIntoAndCropAsCircleImageV1=ALLoadFromStreamAndFitIntoAndCropToCircleBitmap');
      LOldToNewNames.add('ALFitIntoAndCropAsCircleImageV2=ALLoadFromStreamAndFitIntoAndCropToCircleSkSurface');
      LOldToNewNames.add('ALFitIntoAndCropAsCircleImageV3=ALLoadFromStreamAndFitIntoAndCropToCircleDrawable');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsCircleImageV1=ALLoadFromResourceAndFitIntoAndCropToCircleBitmap');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsCircleImageV2=ALLoadFromResourceAndFitIntoAndCropToCircleSkSurface');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceAsCircleImageV3=ALLoadFromResourceAndFitIntoAndCropToCircleDrawable');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsCircleImageV1=ALLoadFromStreamAndFitIntoAndCropAndBlurToCircleBitmap');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsCircleImageV2=ALLoadFromStreamAndFitIntoAndCropAndBlurToCircleSkSurface');
      LOldToNewNames.add('ALBlurFitIntoAndCropAsCircleImageV3=ALLoadFromStreamAndFitIntoAndCropAndBlurToCircleDrawable');
      LOldToNewNames.add('ALFitIntoAndCropImageV1=ALLoadFromStreamAndFitIntoAndCropToBitmap');
      LOldToNewNames.add('ALFitIntoAndCropImageV2=ALLoadFromStreamAndFitIntoAndCropToSkSurface');
      LOldToNewNames.add('ALFitIntoAndCropImageV3=ALLoadFromStreamAndFitIntoAndCropToDrawable');
      LOldToNewNames.add('ALBlurFitIntoAndCropImageV1=ALLoadFromStreamAndFitIntoAndCropAndBlurToBitmap');
      LOldToNewNames.add('ALBlurFitIntoAndCropImageV2=ALLoadFromStreamAndFitIntoAndCropAndBlurToSkSurface');
      LOldToNewNames.add('ALBlurFitIntoAndCropImageV3=ALLoadFromStreamAndFitIntoAndCropAndBlurToDrawable');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceImageV1=ALLoadFromResourceAndFitIntoAndCropToBitmap');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceImageV2=ALLoadFromResourceAndFitIntoAndCropToSkSurface');
      LOldToNewNames.add('ALLoadFitIntoAndCropResourceImageV3=ALLoadFromResourceAndFitIntoAndCropToDrawable');
      LOldToNewNames.add('ALLoadFitIntoAndCropFileImageV1=ALLoadFromFileAndFitIntoAndCropToBitmap');
      LOldToNewNames.add('ALLoadFitIntoAndCropFileImageV2=ALLoadFromFileAndFitIntoAndCropToSkSurface');
      LOldToNewNames.add('ALLoadFitIntoAndCropFileImageV3=ALLoadFromFileAndFitIntoAndCropToDrawable');
      LOldToNewNames.add('ALFitIntoImageV1=ALLoadFromStreamAndFitIntoToBitmap');
      LOldToNewNames.add('ALFitIntoImageV2=ALLoadFromStreamAndFitIntoToSkSurface');
      LOldToNewNames.add('ALFitIntoImageV3=ALLoadFromStreamAndFitIntoToDrawable');
      LOldToNewNames.add('ALLoadFitIntoResourceImageV1=ALLoadFromResourceAndFitIntoToBitmap');
      LOldToNewNames.add('ALLoadFitIntoResourceImageV2=ALLoadFromResourceAndFitIntoToSkSurface');
      LOldToNewNames.add('ALLoadFitIntoResourceImageV3=ALLoadFromResourceAndFitIntoToDrawable');
      LOldToNewNames.add('ALLoadFitIntoFileImageV1=ALLoadFromFileAndFitIntoToBitmap');
      LOldToNewNames.add('ALLoadFitIntoFileImageV2=ALLoadFromFileAndFitIntoToSkSurface');
      LOldToNewNames.add('ALLoadFitIntoFileImageV3=ALLoadFromFileAndFitIntoToDrawable');
      LOldToNewNames.add('ALStretchImageV1=ALLoadFromStreamAndStretchToBitmap');
      LOldToNewNames.add('ALStretchImageV2=ALLoadFromStreamAndStretchToSkSurface');
      LOldToNewNames.add('ALStretchImageV3=ALLoadFromStreamAndStretchToDrawable');
      LOldToNewNames.add('ALLoadStretchResourceImageV1=ALLoadFromResourceAndStretchToBitmap');
      LOldToNewNames.add('ALLoadStretchResourceImageV2=ALLoadFromResourceAndStretchToSkSurface');
      LOldToNewNames.add('ALLoadStretchResourceImageV3=ALLoadFromResourceAndStretchToDrawable');
      LOldToNewNames.add('ALLoadStretchFileImageV1=ALLoadFromFileAndStretchToBitmap');
      LOldToNewNames.add('ALLoadStretchFileImageV2=ALLoadFromFileAndStretchToSkSurface');
      LOldToNewNames.add('ALLoadStretchFileImageV3=ALLoadFromFileAndStretchToDrawable');
      LOldToNewNames.add('ALLoadNormalizeOrientationImageV1=ALLoadFromStreamAndNormalizeOrientationToBitmap');
      LOldToNewNames.add('ALLoadNormalizeOrientationImageV2=ALLoadFromStreamAndNormalizeOrientationToSkSurface');
      LOldToNewNames.add('ALLoadNormalizeOrientationImageV3=ALLoadFromStreamAndNormalizeOrientationToDrawable');
      LOldToNewNames.add('ALLoadNormalizeOrientationFileImageV1=ALLoadFromFileAndNormalizeOrientationToBitmap');
      LOldToNewNames.add('ALLoadNormalizeOrientationFileImageV2=ALLoadFromFileAndNormalizeOrientationToSkSurface');
      LOldToNewNames.add('ALLoadNormalizeOrientationFileImageV3=ALLoadFromFileAndNormalizeOrientationToDrawable');
      LOldToNewNames.add('ALCreateDrawingSurface=ALCreateSurface');
      LOldToNewNames.add('ALPaintRectangle=ALDrawRectangle');
      LOldToNewNames.add('ALPaintCircle=ALDrawCircle');
      ...
      LOldToNewNames.add('TALIniFile=TALIniFileA');

...
FOR /F "usebackq tokens=3*" %%A IN (`reg query "HKCU\Software\Embarcadero\BDS\%ALDelphiVersion%\PlatformSDKs" /v Default_OSX64`) DO set Default_OSX64=%%A
set PlatformSDK=%Default_OSX64%
...
SET OutputDir=%ALBaseDir%\Tools\NativeBridgeFileGenerator\OutputOSX

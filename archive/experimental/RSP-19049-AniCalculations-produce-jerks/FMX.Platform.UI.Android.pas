...
{                                                       }
{ Copyright(c) 2018-2021 Embarcadero Technologies, Inc. }
{              All rights reserved                      }
{                                                       }
{*******************************************************}
...
uses
  ...
  FMX.Platform, FMX.MultiTouch.Android, FMX.ZOrder.Android, FMX.Platform.Text.Android, ALFmxInertialMovement;
...
begin
  ...
  // Process all the pending input events before to redraw the form
  // NOTE: when the mouse is down, MouseMove is continuously firing
  for var i := ALAniCalcTimerProcs.Count - 1 downto 0 do
...
begin
  ...
  begin
    ...
    if FormHandle.FormLayout.getParent <> nil then
      MainActivity.getContentView.removeView(FormHandle.FormLayout);
  end;
end;

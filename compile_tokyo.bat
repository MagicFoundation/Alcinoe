...
rmdir /s /q source\dcu\Win32\tokyo
IF ERRORLEVEL 1 pause

mkdir source\dcu\Win32\tokyo
IF ERRORLEVEL 1 pause

rmdir /s /q source\hpp\Win32\tokyo
IF ERRORLEVEL 1 pause

mkdir source\hpp\Win32\tokyo
IF ERRORLEVEL 1 pause

rmdir /s /q lib\alcinoe\Win32\tokyo
IF ERRORLEVEL 1 pause

mkdir lib\alcinoe\Win32\tokyo
IF ERRORLEVEL 1 pause

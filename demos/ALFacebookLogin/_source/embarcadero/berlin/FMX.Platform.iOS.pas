...
{ TFMXTextEditActionsMenu }
  ...
  private
    [Weak] FGestureControl: TComponent; //https://quality.embarcadero.com/browse/RSP-14086?filter=-2
...
begin
  ...
  //https://quality.embarcadero.com/browse/RSP-12936
  FView.fChangedFocusedControl := true;
  FView.fContextMenu.Control := nil;
...
begin
  ...
  begin
    ...
    if AForm is TCustomForm then
      RootViewController.StatusBarColor := $FF000000; // TCustomForm(AForm).Fill.Color;
  end;
end;

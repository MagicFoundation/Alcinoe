...
type
  TForm1 = class(TForm)
    ...
    ButtonMakeanExceptionforFireBaseCrash: TButton;
    procedure FormCreate(Sender: TObject);
    procedure FormDestroy(Sender: TObject);
    procedure ButtonGetTokenClick(Sender: TObject);
    procedure ButtonMakeanExceptionforFireBaseCrashClick(Sender: TObject);
...
begin
  ...
  {$IF defined(ANDROID)}
  TJALFirebaseCrash.javaclass.report(StringToJstring(aReport.Report));
  {$ELSEIF defined(IOS)}
  FIRCrashLogv(StringToID(aReport.Report));
  {$ENDIF}
  ...
  TThread.CreateAnonymousThread(
    ...
    begin
      ShowNotification('Notification Title',
                       'Notification Text',
                       'https://scontent.xx.fbcdn.net/v/t1.0-0/s640x640/15241923_10154381180856144_3095960088143766901_n.jpg?oh=06f49a585effcabd9c14c4e6a7fd8c2f&oe=59B433BE',
                       'Notification Ticker');
    end).Start;
end;
...
{***************************************************************************}
procedure TForm1.ButtonMakeanExceptionforFireBaseCrashClick(Sender: TObject);
begin
  raise Exception.Create('My Custom Exception');
end;

...
begin
  if (FCurrentMaterial = FTexMat) or (FCurrentMaterial = FExternalOESTexMat) then  // << https://quality.embarcadero.com/browse/RSP-16830
  begin
    ...
    else FExternalOESTexMat.Texture := FCurrentTexture;  // << https://quality.embarcadero.com/browse/RSP-16830
...
begin
  ...
  SubdivCount := Max(Ceil(2 * Pi * Max(Radius.X, Radius.Y) / MinFlatDistance), 40); // https://quality.embarcadero.com/browse/RSP-15206

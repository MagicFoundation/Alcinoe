...
initialization
  TPresentationProxyFactory.Current.Register('default-native', TiOSPresentationProxy<TiOSStyledPresentation>);
finalization
  TPresentationProxyFactory.Current.Unregister('default-native', TiOSPresentationProxy<TiOSStyledPresentation>);
end.

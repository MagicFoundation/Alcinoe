...
type
  ...
  TWinWBMediator = class(TInterfacedObject, ICustomBrowser, ICustomBrowserEx)
  private
  ...
  public
    ...
    property WBEx: TWindowsWebBrowserService read FBrowser implements ICustomBrowserEx;
  end;

  TWindowsWebBrowserService = class(TOLEFrameworkDelegate, ICustomBrowser, ICustomBrowserEx)
  private
    FCache: Boolean;
    FCanGoBack: Boolean;
  ...
  public
    ...
    procedure LoadFromStrings(const Content: string; const BaseUrl: string); overload;
    procedure LoadFromStrings(const Content: string; const ContentEncoding: TEncoding; const BaseUrl: string); overload;
    procedure GoBack;
    procedure GoForward;
    procedure GoHome;
...
procedure TWindowsWebBrowserService.LoadFromStrings(const Content: string; const BaseUrl: string);
begin
  LoadFromStrings(Content, TEncoding.Default, BaseUrl);
end;

procedure TWindowsWebBrowserService.LoadFromStrings(const Content: string; const ContentEncoding: TEncoding; const BaseUrl: string);
...
begin
  StringStream := TStringStream.Create(Content, ContentEncoding);
  try

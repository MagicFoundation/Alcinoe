...
type
  ...
  // technobot 2008-06-25 - methods moved as is from TZSybaseDatabaseMetadata:
...
destructor TZSybaseDatabaseInfo.Destroy;
begin
  inherited;
end;
...
function TZSybaseDatabaseInfo.GetDriverMajorVersion: Integer;
begin
  Result := 1;
end;
...
function TZSybaseDatabaseInfo.GetDriverMinorVersion: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.UsesLocalFilePerTable: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.SupportsMixedCaseIdentifiers: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.StoresUpperCaseIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.StoresLowerCaseIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.StoresMixedCaseIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsMixedCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.StoresUpperCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.StoresLowerCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.StoresMixedCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.GetIdentifierQuoteString: string;
begin
  Result := '"';
end;
...
function TZSybaseDatabaseInfo.GetSQLKeywords: string;
begin
...
function TZSybaseDatabaseInfo.GetNumericFunctions: string;
begin
...
function TZSybaseDatabaseInfo.GetStringFunctions: string;
begin
...
function TZSybaseDatabaseInfo.GetSystemFunctions: string;
begin
...
function TZSybaseDatabaseInfo.GetTimeDateFunctions: string;
begin
...
function TZSybaseDatabaseInfo.GetSearchStringEscape: string;
begin
...
function TZSybaseDatabaseInfo.GetExtraNameCharacters: string;
begin
  Result := '@$#';
end;
...
function TZSybaseDatabaseInfo.SupportsExpressionsInOrderBy: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsOrderByUnrelated: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsGroupBy: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsGroupByUnrelated: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsGroupByBeyondSelect: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsIntegrityEnhancementFacility: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.GetSchemaTerm: string;
begin
  Result := 'owner';
end;
...
function TZSybaseDatabaseInfo.GetProcedureTerm: string;
begin
  Result := 'procedure';
end;
...
function TZSybaseDatabaseInfo.GetCatalogTerm: string;
begin
  Result := 'database';
end;
...
function TZSybaseDatabaseInfo.GetCatalogSeparator: string;
begin
  Result := '.';
end;
...
function TZSybaseDatabaseInfo.SupportsSchemasInDataManipulation: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSchemasInProcedureCalls: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSchemasInTableDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSchemasInIndexDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSchemasInPrivilegeDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCatalogsInDataManipulation: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCatalogsInProcedureCalls: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCatalogsInTableDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCatalogsInIndexDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCatalogsInPrivilegeDefinitions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsPositionedDelete: Boolean;
begin
//CURRENT OF
...
function TZSybaseDatabaseInfo.SupportsPositionedUpdate: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSelectForUpdate: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsStoredProcedures: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSubqueriesInComparisons: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSubqueriesInExists: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSubqueriesInIns: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsSubqueriesInQuantifieds: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsCorrelatedSubqueries: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsUnion: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsUnionAll: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsOpenCursorsAcrossCommit: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsOpenCursorsAcrossRollback: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsOpenStatementsAcrossCommit: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.SupportsOpenStatementsAcrossRollback: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.GetMaxBinaryLiteralLength: Integer;
begin
  Result := 16000;
end;
...
function TZSybaseDatabaseInfo.GetMaxCharLiteralLength: Integer;
begin
  Result := 8000;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnsInGroupBy: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnsInIndex: Integer;
begin
  Result := 16;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnsInOrderBy: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnsInSelect: Integer;
begin
  Result := 4096;
end;
...
function TZSybaseDatabaseInfo.GetMaxColumnsInTable: Integer;
begin
  Result := 1024;
end;
...
function TZSybaseDatabaseInfo.GetMaxConnections: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.GetMaxCursorNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxIndexLength: Integer;
begin
  Result := 900;
end;
...
function TZSybaseDatabaseInfo.GetMaxSchemaNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxProcedureNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxCatalogNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxRowSize: Integer;
begin
  Result := 8060;
end;
...
function TZSybaseDatabaseInfo.DoesMaxRowSizeIncludeBlobs: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.GetMaxStatementLength: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.GetMaxStatements: Integer;
begin
  Result := 0;
end;
...
function TZSybaseDatabaseInfo.GetMaxTableNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetMaxTablesInSelect: Integer;
begin
  Result := 256;
end;
...
function TZSybaseDatabaseInfo.GetMaxUserNameLength: Integer;
begin
  Result := 128;
end;
...
function TZSybaseDatabaseInfo.GetDefaultTransactionIsolation:
...
function TZSybaseDatabaseInfo.SupportsTransactions: Boolean;
begin
  Result := True;
end;
...
function TZSybaseDatabaseInfo.SupportsTransactionIsolationLevel(
...
function TZSybaseDatabaseInfo.DataDefinitionCausesTransactionCommit: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.DataDefinitionIgnoredInTransactions: Boolean;
begin
  Result := False;
end;
...
function TZSybaseDatabaseInfo.SupportsResultSetType(
...
function TZSybaseDatabaseInfo.SupportsResultSetConcurrency(

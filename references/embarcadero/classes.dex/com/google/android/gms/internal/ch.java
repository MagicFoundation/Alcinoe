...
public interface ch extends IInterface {
    ...
    public static abstract class a extends Binder implements ch {
        ...
        private static class a implements ch {
            ...
            public cf b(cd cdVar) throws RemoteException {
                ...
                try {
                    ...
                    cf g = obtain2.readInt() != 0 ? cf.CREATOR.g(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return g;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case APKExpansionPolicy.PATCH_FILE_URL_INDEX /*1*/:
                    ...
                    cf b = b(data.readInt() != 0 ? cd.CREATOR.f(data) : null);
    ...
    cf b(cd cdVar) throws RemoteException;
}

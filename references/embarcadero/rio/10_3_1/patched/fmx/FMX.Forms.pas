...
function TimerService: IFMXTimerService;
begin
  if (GlobalTimerService = nil) and not TPlatformServices.Current.SupportsPlatformService(IFMXTimerService, GlobalTimerService) then
    raise EUnsupportedPlatformService.Create('IFMXTimerService');

  Result := GlobalTimerService;
end;

...
uses
  ...
  FMX.Platform.Screen.iOS, FMX.Platform.Logger.iOS, System.Generics.Collections, ALFmxInertialMovement;
...
procedure TFMXViewController.traitCollectionDidChange(previousTraitCollection: iOSApi.UIKit.UITraitCollection);
var
  TraitCollection: UITraitCollection;
begin
  TraitCollection := TUITraitCollection.Wrap(NSObjectToID(previousTraitCollection));

  UITraitEnvironment(Super).traitCollectionDidChange(TraitCollection);

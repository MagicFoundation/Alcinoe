...
// -------------------------------------------------------------------------------- //
  ...
  //https://quality.embarcadero.com/browse/RSP-24337
  private
...
begin
  ...
  FAllowCookies := True;
  //https://quality.embarcadero.com/browse/RSP-24337
  FPreemptiveAuthentication := False;
  FSecureFailureReasons := [];
  FAutomaticDecompression := [];
  FUseDefaultCredentials := True;
end;
...
{$IFDEF ANDROID}
  ...
  try
    ...
    begin
      ...
      // and this is first call (eg, after first async call - OK), this will block application
      // at TJKeyChain.JavaClass.getPrivateKey call
...
//https://quality.embarcadero.com/browse/RSP-24337
function THTTPClient.GetPreemptiveAuthentication: Boolean;
begin
  Result := FPreemptiveAuthentication;
end;

//https://quality.embarcadero.com/browse/RSP-24337
procedure THTTPClient.SetPreemptiveAuthentication(const AValue: Boolean);
begin
  FPreemptiveAuthentication := AValue;
end;

//https://quality.embarcadero.com/browse/RSP-24337
function THTTPClient.GetSecureFailureReasons: THTTPSecureFailureReasons;
begin
  Result := FSecureFailureReasons;
end;

//https://quality.embarcadero.com/browse/RSP-24337
procedure THTTPClient.SetSecureFailureReasons(const AValue: THTTPSecureFailureReasons);
begin
  FSecureFailureReasons := AValue;
end;

//https://quality.embarcadero.com/browse/RSP-24337
function THTTPClient.GetAutomaticDecompression: THTTPCompressionMethods;
begin
  Result := FAutomaticDecompression;
end;

//https://quality.embarcadero.com/browse/RSP-24337
procedure THTTPClient.SetAutomaticDecompression(const AValue: THTTPCompressionMethods);
begin
  FAutomaticDecompression := AValue;
end;

function THTTPClient.GetUseDefaultCredentials: Boolean;
begin
  Result := FUseDefaultCredentials;
end;

procedure THTTPClient.SetUseDefaultCredentials(const AValue: Boolean);
begin
  FUseDefaultCredentials := AValue;
end;

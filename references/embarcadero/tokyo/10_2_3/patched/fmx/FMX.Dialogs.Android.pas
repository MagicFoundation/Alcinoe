...
uses
  ...
  FMX.Platform, FMX.Consts, FMX.Forms, fmx.types;
...
begin
  ...
  begin
    ...
    begin
      LCaptions.Items[ButtonIndex] := StringToJString(translate(ButtonCaptions[B]));  // https://quality.embarcadero.com/browse/RSP-15970?filter=-2
      case ButtonIndex of

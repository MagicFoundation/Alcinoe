...
// ===== Forward declarations =====
  ...
  JNotificationChannel = interface; // https://quality.embarcadero.com/browse/RSP-21294
...
// ===== Interface declarations =====
  ...
  JActivity = interface(JContextThemeWrapper)
    ...
    procedure onVisibleBehindCanceled; cdecl;
    ...
    function requestVisibleBehind(visible: Boolean): Boolean; cdecl;
  ...
  JActivityManager = interface(JObject)
    ...
    function getRunningServices(maxNum: Integer): JList; cdecl;
  ...
  JAlarmManager = interface(JObject)
    ...
    procedure setExact(type_: Integer; triggerAtMillis: Int64; operation: JPendingIntent); cdecl;
    ...
    procedure setWindow(type_: Integer; windowStartMillis: Int64; windowLengthMillis: Int64; operation: JPendingIntent); cdecl;
  end;
  ...
  JNotificationChannelClass = interface(JObjectClass)
    ['{8919BA5B-A839-4415-8E56-C03B6D8983D3}']
  ...
  JNotificationChannel = interface(JObject)
    ['{D1F09359-0A17-42CB-8693-226533CF7830}']
  ...
  JNotificationManager = interface(JObject)
    ...
    procedure createNotificationChannel(channel: JNotificationChannel); cdecl; // https://quality.embarcadero.com/browse/RSP-21294
  end;
  ...
  JNotificationManager_PolicyClass = interface(JObjectClass)
    ...
    {class} function init(priorityCategories: Integer; priorityCallSenders: Integer; priorityMessageSenders: Integer): JNotificationManager_Policy; cdecl;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.App.JNotificationChannel', TypeInfo(Androidapi.JNI.App.JNotificationChannel)); // https://quality.embarcadero.com/browse/RSP-21294

...
type
  ...
  public
    ...
    class procedure CheckGLErrors(const aContextMethod: String); // https://quality.embarcadero.com/browse/RSP-21577
...
// https://quality.embarcadero.com/browse/RSP-21577
class procedure TCustomContextOpenGL.CheckGLErrors(const aContextMethod: String);

  procedure _RaiseContextException(Flag: integer);
  var s: String;
  begin
    S := '';
    while Flag <> GL_NO_ERROR do begin
      case flag of
        GL_INVALID_ENUM: S := S + 'GL_INVALID_ENUM + ';
        GL_INVALID_VALUE: S := S + 'GL_INVALID_VALUE + ';
        GL_INVALID_OPERATION: S := S + 'GL_INVALID_OPERATION + ';
        GL_INVALID_FRAMEBUFFER_OPERATION: S := S + 'GL_INVALID_FRAMEBUFFER_OPERATION + ';
        GL_OUT_OF_MEMORY: S := S + 'GL_OUT_OF_MEMORY + ';
        1284: S := S + 'GL_STACK_UNDERFLOW + ';
        1283: S := S + 'GL_STACK_OVERFLOW + ';
        else S := S + inttostr(flag) + ' + ';
      end;
      Flag := glGetError;
    end;
    if s <> '' then delete(S, length(S)-2, 3);
    {$IFDEF ANDROID}
    Log.d('[Context Exception]: ' + Format('Error in context method %s: %s', [aContextMethod, S]));
    {$ENDIF}
    raise EContext3DException.CreateFmt('Error in context method %s: %s', [aContextMethod, S]);
  end;
...
begin
  ...
  if Valid then
  begin
    {$IFNDEF ANDROID} // Android context makes own initialization
    ...
    CheckGLErrors('DoBeginScene'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  if Valid then
  begin
    {$IFNDEF ANDROID} // Android context makes own finalization
    if FFrameBuf <> 0 then
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoSetContextState'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoClear'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      CheckGLErrors('DoCopyToBitmap'); // https://quality.embarcadero.com/browse/RSP-21577
    end else begin
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoCopyToBits'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoDrawPrimitivesBatch'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  CheckGLErrors('DoDrawPrimitives'); // https://quality.embarcadero.com/browse/RSP-21577
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoSetStencilOp'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoSetStencilFunc'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoInitializeTexture'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoFinalizeTexture'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
...
begin
  ...
  begin
    ...
    glBindTexture(GL_TEXTURE_2D, 0);
    CheckGLErrors('DoUpdateTexture'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('BuildShader'); // https://quality.embarcadero.com/browse/RSP-21577
  end
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('FindProgram'); // https://quality.embarcadero.com/browse/RSP-21577
...
begin
  ...
  begin
    ...
    CheckGLErrors('UseProgram'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoFinalizeShader'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
  Shader.Handle := 0;
end;
...
begin
  ...
  begin
    ...
    CheckGLErrors('DoSetShaderVariable'); // https://quality.embarcadero.com/browse/RSP-21577
  end;
end;

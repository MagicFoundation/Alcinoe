...
// ===== Interface declarations =====
  ...
  JNotificationCompat_BuilderClass = interface(JObjectClass)
    ...
    {class} function init(context: JContext): JNotificationCompat_Builder; cdecl; overload; // https://quality.embarcadero.com/browse/RSP-18070
    {class} function init(context: JContext; channelId: JString): JNotificationCompat_Builder; cdecl; overload; // https://quality.embarcadero.com/browse/RSP-18070
  end;
  ...
  JNotificationCompat_Builder = interface(JObject)
    ...
    function setColor(argb: integer): JNotificationCompat_Builder; cdecl; // https://quality.embarcadero.com/browse/RSP-18070
    function setShowWhen(show: boolean): JNotificationCompat_Builder; cdecl; // https://quality.embarcadero.com/browse/RSP-18070
    function setChannelId(channelId: JString): JNotificationCompat_Builder; cdecl; // https://quality.embarcadero.com/browse/RSP-18070
  end;

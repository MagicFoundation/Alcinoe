...
void NumberFormat::SharedCtor() {
  ...
  national_prefix_formatting_rule_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  national_prefix_optional_when_formatting_ = false;
  domestic_carrier_code_formatting_rule_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void NumberFormat::SharedDtor() {
  ...
  if (national_prefix_formatting_rule_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete national_prefix_formatting_rule_;
  }
  if (domestic_carrier_code_formatting_rule_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
void PhoneNumberDesc::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  national_number_pattern_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  possible_number_pattern_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  example_number_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void PhoneNumberDesc::SharedDtor() {
  if (national_number_pattern_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete national_number_pattern_;
  }
  if (possible_number_pattern_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete possible_number_pattern_;
  }
  if (example_number_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
void PhoneMetadata::SharedCtor() {
  ...
  country_code_ = 0;
  international_prefix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  preferred_international_prefix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  national_prefix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  preferred_extn_prefix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  national_prefix_for_parsing_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  national_prefix_transform_rule_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  same_mobile_and_fixed_line_pattern_ = false;
  main_country_for_code_ = false;
  leading_digits_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void PhoneMetadata::SharedDtor() {
  ...
  if (international_prefix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete international_prefix_;
  }
  if (preferred_international_prefix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete preferred_international_prefix_;
  }
  if (national_prefix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete national_prefix_;
  }
  if (preferred_extn_prefix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete preferred_extn_prefix_;
  }
  if (national_prefix_for_parsing_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete national_prefix_for_parsing_;
  }
  if (national_prefix_transform_rule_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete national_prefix_transform_rule_;
  }
  if (leading_digits_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[24 / 32] & 2030043136) {

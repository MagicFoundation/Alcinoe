...
extern DELPHI_PACKAGE void __fastcall ALPaintRectangle(Fmx::Graphics::TCanvas* const aCanvas, const System::Types::TRectF &dstRect, Fmx::Graphics::TBrush* const Fill, Fmx::Graphics::TStrokeBrush* const Stroke, const Fmx::Types::TSides Sides, const Fmx::Types::TCorners Corners, const float XRadius = 0.000000E+00f, const float YRadius = 0.000000E+00f);
}	/* namespace Alfmxcommon */

...
// (DO NOT EDIT: machine generated header) 'Alcinoe_berlin.dpk' rev: 31.00 (Windows)

#ifndef Alcinoe_berlinHPP
#define Alcinoe_berlinHPP
...
namespace Alcinoe_berlin
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Alcinoe_berlin */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ALCINOE_BERLIN)
using namespace Alcinoe_berlin;
#endif
#pragma pack(pop)
#pragma option pop

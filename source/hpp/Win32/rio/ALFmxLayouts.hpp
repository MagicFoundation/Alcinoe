...
// (DO NOT EDIT: machine generated header) 'ALFmxLayouts.pas' rev: 33.00 (Windows)
...
public:
	/* TControl.Destroy */ inline __fastcall virtual ~TALLayout() { }
...
public:
	/* TControl.Destroy */ inline __fastcall virtual ~TALScrollBoxContent() { }
...
public:
	...
	__property TALCustomScrollBox* ScrollBox = {read=FScrollBox};
public:
	/* TALAniCalculations.Destroy */ inline __fastcall virtual ~TALScrollBoxAniCalculations() { }
...
public:
	/* TALCustomTrack.Destroy */ inline __fastcall virtual ~TALScrollBoxBar() { }
...
private:
	...
	bool __fastcall isMaxContentHeightStored();
	bool __fastcall isMaxContentWidthStored();
	...
	void __fastcall internalMouseLeave();
...
protected:
	...
	virtual TALScrollBoxContent* __fastcall CreateContent();
	virtual TALScrollBoxAniCalculations* __fastcall CreateAniCalculations();
	virtual System::Types::TRectF __fastcall CalcContentBounds();
...
public:
	...
	__fastcall virtual ~TALCustomScrollBox();
...
public:
	/* TALCustomScrollBox.Destroy */ inline __fastcall virtual ~TALScrollBox() { }
...
__published:
	...
	__property OnAniStop;
public:
	/* TALCustomScrollBox.Destroy */ inline __fastcall virtual ~TALVertScrollBox() { }
...
__published:
	...
	__property OnAniStop;
public:
	/* TALCustomScrollBox.Destroy */ inline __fastcall virtual ~TALHorzScrollBox() { }

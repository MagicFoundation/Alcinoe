...
// (DO NOT EDIT: machine generated header) 'ALFmxStdCtrls.pas' rev: 33.00 (Windows)
...
private:
	...
	bool __fastcall ResourceNameStored();
...
public:
	...
	__fastcall virtual ~TALAniIndicator();
...
public:
	/* TALImage.Destroy */ inline __fastcall virtual ~TALTrackThumbGlyph() { }
...
public:
	...
	__fastcall virtual ~TALTrackThumb();
...
__published:
	...
	__property HitTest = {default=0};
public:
	/* TALRectangle.Destroy */ inline __fastcall virtual ~TALTrackBackground() { }
...
__published:
	...
	__property HitTest = {default=0};
public:
	/* TALRectangle.Destroy */ inline __fastcall virtual ~TALTrackHighlight() { }
...
private:
	...
	bool __fastcall ThumbSizeStored();
...
protected:
	...
	virtual float __fastcall GetViewportSize();
	virtual float __fastcall GetFrequency();
	virtual void __fastcall SetFrequency(const float Value);
	virtual float __fastcall GetMax();
	virtual void __fastcall SetMax(const float Value);
	virtual float __fastcall GetMin();
	virtual void __fastcall SetMin(const float Value);
	virtual float __fastcall GetValue();
	...
	virtual void __fastcall UpdateHighlight();
	
public:
	__fastcall virtual TALCustomTrack(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TALCustomTrack();
...
__published:
	...
	__property OnResized;
public:
	/* TALCustomTrack.Destroy */ inline __fastcall virtual ~TALTrackBar() { }
...
__published:
	...
	__property OnResized;
public:
	/* TALCustomTrack.Destroy */ inline __fastcall virtual ~TALScrollBar() { }
...
protected:
	...
	virtual void __fastcall SetMax(const float Value);
	virtual void __fastcall SetMin(const float Value);
	virtual bool __fastcall MaxValueStored();
	virtual System::Types::TSizeF __fastcall GetDefaultSize();
	virtual void __fastcall SetValue(float Value);
	virtual float __fastcall GetMaxValue();
...
public:
	...
	__fastcall virtual ~TALRangeTrackBar();
...
protected:
	...
	virtual void __fastcall DoChanged();
	virtual System::Types::TSizeF __fastcall GetDefaultSize();
	virtual bool __fastcall GetIsChecked();
	virtual void __fastcall SetIsChecked(const bool Value);
	virtual bool __fastcall ImageCheckedResourceNameStored();
	virtual bool __fastcall ImageUncheckedResourceNameStored();
	
public:
	__fastcall virtual TALCheckBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TALCheckBox();
	virtual Fmx::Graphics::TBitmap* __fastcall MakeBufBitmap();
	virtual void __fastcall clearBufBitmap();
	virtual void __fastcall MouseDown(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, float X, float Y);
	virtual void __fastcall MouseMove(System::Classes::TShiftState Shift, float X, float Y);
...
public:
	...
	__fastcall virtual ~TALRadioButton();
...
__published:
	...
	__property HitTest = {default=0};
public:
	/* TALRectangle.Destroy */ inline __fastcall virtual ~TALSwitchThumb() { }
...
__published:
	...
	__property HitTest = {default=0};
public:
	/* TALRectangle.Destroy */ inline __fastcall virtual ~TALSwitchBackground() { }

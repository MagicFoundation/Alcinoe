...
// (DO NOT EDIT: machine generated header) 'ALFmxTabControl.pas' rev: 33.00 (Windows)
...
private:
	...
	TALTabItem* __fastcall GetActiveTab();
	void __fastcall SetActiveTab(TALTabItem* const Value);
	bool __fastcall getAnimationEnabled();
...
public:
	...
	__fastcall virtual ~TALTabControl();

...
// (DO NOT EDIT: machine generated header) 'ALGraphics.pas' rev: 33.00 (Windows)
...
__interface DELPHIINTERFACE TALResizeAndBlurImageGetDestSizeFunct;
...
extern DELPHI_PACKAGE System::DynamicArray<System::Byte> __fastcall AlGetImageSignature(System::Classes::TStream* const aStream, const int aSignatureLength = 0xc)/* overload */;
extern DELPHI_PACKAGE System::DynamicArray<System::Byte> __fastcall AlGetImageSignature(const System::UnicodeString aFileName, const int aSignatureLength = 0xc)/* overload */;

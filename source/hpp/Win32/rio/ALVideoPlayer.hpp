...
// (DO NOT EDIT: machine generated header) 'ALVideoPlayer.pas' rev: 33.00 (Windows)
...
public:
	__fastcall virtual TALWinVideoPlayer();
	__fastcall virtual ~TALWinVideoPlayer();
	__int64 __fastcall getCurrentPosition();
...
public:
	__fastcall virtual TALVideoPlayer();
	__fastcall virtual ~TALVideoPlayer();
	__int64 __fastcall getCurrentPosition();
	__int64 __fastcall getDuration();
	int __fastcall getVideoHeight();
...
private:
	...
	TALVideoSizeChangedNotifyEvent __fastcall GetVideoSizeChangedEvent();
...
public:
	...
	__fastcall virtual ~TALVideoPlayerSurface();
	void __fastcall resetVideoPlayer();

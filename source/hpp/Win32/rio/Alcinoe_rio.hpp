...
#ifndef Alcinoe_rioHPP
#define Alcinoe_rioHPP
...
// PRG_EXT: .bpl
// BPI_DIR: ..\lib\bpl\alcinoe\Win32\rio
// OBJ_DIR: ..\lib\bpl\alcinoe\Win32\rio
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Alcinoe_rio
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Alcinoe_rio */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ALCINOE_RIO)
using namespace Alcinoe_rio;
#endif
#pragma pack(pop)
#pragma option pop

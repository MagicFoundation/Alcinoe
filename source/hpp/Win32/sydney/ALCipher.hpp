...
// (DO NOT EDIT: machine generated header) 'ALCipher.pas' rev: 34.00 (Windows)
...
class DELPHICLASS EALCipherExceptionU;
struct TALBFContext;
struct TALRDLVector;
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION EALCipherExceptionU : public Alcommon::EALExceptionU
{
	typedef Alcommon::EALExceptionU inherited;
	
public:
	/* Exception.Create */ inline __fastcall EALCipherExceptionU(const System::UnicodeString Msg) : Alcommon::EALExceptionU(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EALCipherExceptionU(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : Alcommon::EALExceptionU(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EALCipherExceptionU(NativeUInt Ident)/* overload */ : Alcommon::EALExceptionU(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EALCipherExceptionU(System::PResStringRec ResStringRec)/* overload */ : Alcommon::EALExceptionU(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EALCipherExceptionU(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : Alcommon::EALExceptionU(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EALCipherExceptionU(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : Alcommon::EALExceptionU(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EALCipherExceptionU(const System::UnicodeString Msg, int AHelpContext) : Alcommon::EALExceptionU(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EALCipherExceptionU(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : Alcommon::EALExceptionU(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EALCipherExceptionU(NativeUInt Ident, int AHelpContext)/* overload */ : Alcommon::EALExceptionU(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EALCipherExceptionU(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : Alcommon::EALExceptionU(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EALCipherExceptionU(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Alcommon::EALExceptionU(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EALCipherExceptionU(NativeUInt Ident, const System::TVarRec *Args, const int Args_High, int AHelpContext)/* overload */ : Alcommon::EALExceptionU(Ident, Args, Args_High, AHelpContext) { }
	/* Exception.Destroy */ inline __fastcall virtual ~EALCipherExceptionU() { }
...
extern DELPHI_PACKAGE unsigned __fastcall (*ALStringHashCrc32)(const System::AnsiString str);
extern DELPHI_PACKAGE unsigned __fastcall (*ALHashCrc32)(char * buf, unsigned len);
extern DELPHI_PACKAGE __int64 __fastcall (*ALStringHashCrc64)(const System::AnsiString str);
extern DELPHI_PACKAGE __int64 __fastcall (*ALHashCrc64)(char * buf, unsigned len);

...
// (DO NOT EDIT: machine generated header) 'ALFmxCommon.pas' rev: 34.00 (Windows)
...
public:
	/* {System_Generics_Collections}TObjectList<ALFmxCommon_TALBreakTextItem>.Create */ inline __fastcall TALBreakTextItems()/* overload */ : System::Generics::Collections::TObjectList__1<TALBreakTextItem*>() { }

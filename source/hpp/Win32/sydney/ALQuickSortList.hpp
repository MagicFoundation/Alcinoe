...
// (DO NOT EDIT: machine generated header) 'ALQuickSortList.pas' rev: 34.00 (Windows)
...
private:
	...
	void __fastcall QuickSort(int L, int R, TALQuickSortListCompare ACompare);
...
public:
	__fastcall TALBaseQuickSortList();
	__fastcall virtual ~TALBaseQuickSortList();
	...
	TALBaseQuickSortList* __fastcall Expand();
...
public:
	__fastcall TALIntegerList()/* overload */;
	...
	int __fastcall Pop();
	int __fastcall Peek();
	System::DynamicArray<int> __fastcall ToArray();
public:
	/* TALBaseQuickSortList.Destroy */ inline __fastcall virtual ~TALIntegerList() { }
...
public:
	__fastcall TALCardinalList()/* overload */;
	...
	unsigned __fastcall Peek();
	System::DynamicArray<unsigned> __fastcall ToArray();
public:
	/* TALBaseQuickSortList.Destroy */ inline __fastcall virtual ~TALCardinalList() { }
...
public:
	__fastcall TALInt64List()/* overload */;
	...
	__int64 __fastcall Pop();
	__int64 __fastcall Peek();
	System::DynamicArray<__int64> __fastcall ToArray();
public:
	/* TALBaseQuickSortList.Destroy */ inline __fastcall virtual ~TALInt64List() { }
...
public:
	__fastcall TALNativeIntList()/* overload */;
	...
	NativeInt __fastcall Pop();
	NativeInt __fastcall Peek();
	System::DynamicArray<NativeInt> __fastcall ToArray();
public:
	/* TALBaseQuickSortList.Destroy */ inline __fastcall virtual ~TALNativeIntList() { }
...
public:
	__fastcall TALDoubleList()/* overload */;
	...
	double __fastcall Peek();
	System::DynamicArray<double> __fastcall ToArray();
public:
	/* TALBaseQuickSortList.Destroy */ inline __fastcall virtual ~TALDoubleList() { }

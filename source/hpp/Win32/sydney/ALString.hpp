...
// (DO NOT EDIT: machine generated header) 'ALString.pas' rev: 34.00 (Windows)
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TALStringStream() { }
...
protected:
	virtual Alstringlist::TALStrings* __fastcall GetTagParams() = 0 ;
...
public:
	/* TObject.Create */ inline __fastcall TALBasePrecompiledTag() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TALBasePrecompiledTag() { }
...
protected:
	virtual Alstringlist::TALStrings* __fastcall GetTagParams();
	
public:
	__fastcall TALPrecompiledTag();
	__fastcall virtual ~TALPrecompiledTag();
};
...
extern DELPHI_PACKAGE System::AnsiString __fastcall ALRemoveDiacritic(const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALExpandLigatures(const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUnicodeUpperCaseNoDiacritic(const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUnicodeLowerCaseNoDiacritic(const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUnicodeUpperCase(const System::AnsiString s);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUnicodeLowerCase(const System::AnsiString s);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUnicodeUpperFirstChar(const System::AnsiString s);
...
extern DELPHI_PACKAGE System::AnsiString __fastcall ALStringNormalize(const System::AnsiString S, const char WordSeparator, const char *SymbolsToIgnore, const int SymbolsToIgnore_High)/* overload */;
extern DELPHI_PACKAGE System::AnsiString __fastcall ALStringNormalize(const System::AnsiString S, const char WordSeparator = '\x2d')/* overload */;
extern DELPHI_PACKAGE System::AnsiString __fastcall ALISO91995CyrillicToLatin(const System::AnsiString aCyrillicText);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALBGNPCGN1947CyrillicToLatin(const System::AnsiString aCyrillicText);
...
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8Normalize _DEPRECATED_ATTRIBUTE1("use ALStringNormalize instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString S, const char WordSeparator = '\x2d')/* overload */;
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8RemoveDiacritic _DEPRECATED_ATTRIBUTE1("use ALRemoveDiacritic instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8ExpandLigatures _DEPRECATED_ATTRIBUTE1("use ALExpandLigatures instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8UpperCaseNoDiacritic _DEPRECATED_ATTRIBUTE1("use ALUnicodeUpperCaseNoDiacritic instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8LowerCaseNoDiacritic _DEPRECATED_ATTRIBUTE1("use ALUnicodeLowerCaseNoDiacritic instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString S);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8UpperCase _DEPRECATED_ATTRIBUTE1("use ALUnicodeUpperCase instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString s);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8LowerCase _DEPRECATED_ATTRIBUTE1("use ALUnicodeLowerCase instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString s);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8UpperFirstChar _DEPRECATED_ATTRIBUTE1("use ALUnicodeUpperFirstChar instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString s);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8ISO91995CyrillicToLatin _DEPRECATED_ATTRIBUTE1("use ALISO91995CyrillicToLatin instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString aCyrillicText);
extern DELPHI_PACKAGE System::AnsiString __fastcall ALUTF8BGNPCGN1947CyrillicToLatin _DEPRECATED_ATTRIBUTE1("use ALBGNPCGN1947CyrillicToLatin instead with SetMultiByteConversionCodePage(CP_UTF8)") (const System::AnsiString aCyrillicText);
}	/* namespace Alstring */

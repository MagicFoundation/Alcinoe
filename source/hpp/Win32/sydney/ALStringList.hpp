...
// (DO NOT EDIT: machine generated header) 'ALStringList.pas' rev: 34.00 (Windows)
...
private:
	...
	void __fastcall QuickSort(int L, int R, _di_TALStringListSortCompare ACompare);
...
private:
	...
	void __fastcall ExchangeItems(int Index1, int Index2);
	void __fastcall Grow();
	void __fastcall QuickSort(int L, int R, _di_TALNVStringListSortCompare ACompare);
	void __fastcall SetSorted(bool Value);
	void __fastcall SetCaseSensitive(const bool Value);
...
private:
	...
	bool FOwnsObject;
	void __fastcall ExchangeItems(int Index1, int Index2);
	void __fastcall QuickSort(int L, int R, TALAVLStringListSortCompare ACompare);
	void __fastcall SetCaseSensitive(const bool Value);
...
private:
	...
	bool FCaseSensitive;
	void __fastcall ExchangeItems(int Index1, int Index2);
	void __fastcall QuickSort(int L, int R, TALHashedStringListSortCompare ACompare);
	void __fastcall SetCaseSensitive(const bool Value);
	bool __fastcall GetCaseSensitive();
	bool __fastcall ExtractNameValue(const System::AnsiString S, System::AnsiString &Name, System::AnsiString &Value);
	void __fastcall SetDuplicates(const System::Types::TDuplicates Value);
...
private:
	...
	void __fastcall ExchangeItems(int Index1, int Index2);
	void __fastcall Grow();
	void __fastcall QuickSort(int L, int R, _di_TALStringListSortCompareU ACompare);
	void __fastcall SetSorted(bool Value);
	void __fastcall SetCaseSensitive(const bool Value);
...
private:
	...
	void __fastcall ExchangeItems(int Index1, int Index2);
	void __fastcall Grow();
	void __fastcall QuickSort(int L, int R, _di_TALNVStringListSortCompareU ACompare);
	void __fastcall SetSorted(bool Value);
	void __fastcall SetCaseSensitive(const bool Value);

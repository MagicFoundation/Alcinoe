...
// (DO NOT EDIT: machine generated header) 'Alcinoe_sydney.dpk' rev: 34.00 (Windows)

#ifndef Alcinoe_sydneyHPP
#define Alcinoe_sydneyHPP
...
// PRG_EXT: .bpl
// BPI_DIR: ..\lib\bpl\alcinoe\Win32\sydney
// OBJ_DIR: ..\lib\bpl\alcinoe\Win32\sydney
// OBJ_EXT: .obj

//-- user supplied -----------------------------------------------------------

namespace Alcinoe_sydney
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Alcinoe_sydney */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ALCINOE_SYDNEY)
using namespace Alcinoe_sydney;
#endif
#pragma pack(pop)
#pragma option pop

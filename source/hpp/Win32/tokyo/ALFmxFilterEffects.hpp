...
public:
	...
	__fastcall virtual TALColorAdjustShaderVariables(void);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TALColorAdjustShaderVariables(void) { }
...
public:
	...
	/* TFilterEffect.Destroy */ inline __fastcall virtual ~TALColorAdjustEffect(void) { }

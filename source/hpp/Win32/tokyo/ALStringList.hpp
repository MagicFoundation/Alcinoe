...
// (DO NOT EDIT: machine generated header) 'ALStringList.pas' rev: 32.00 (Windows)
...
__interface TALStringListSortCompare;
...
__interface TALNVStringListSortCompare;
...
__interface TALStringListSortCompareU;
...
__interface TALNVStringListSortCompareU;
...
public:
	...
	System::AnsiString __fastcall GetCurrent(void);
	bool __fastcall MoveNext(void);
	__property System::AnsiString Current = {read=GetCurrent};
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TALStringsEnumerator(void) { }
...
private:
	...
	System::AnsiString __fastcall GetDelimitedText(void);
...
public:
	__fastcall virtual TALStrings(void);
	...
	TALStringsEnumerator* __fastcall GetEnumerator(void);
	...
	System::DynamicArray<System::AnsiString> __fastcall ToStringArray(void);
	System::DynamicArray<System::TObject*> __fastcall ToObjectArray(void);
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TALStrings(void) { }
...
public:
	__fastcall virtual TALStringList(void)/* overload */;
	__fastcall TALStringList(bool OwnsObjects)/* overload */;
	__fastcall virtual ~TALStringList(void);
	virtual int __fastcall Add(const System::AnsiString S);
	virtual int __fastcall AddObject(const System::AnsiString S, System::TObject* AObject);
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
...
public:
	__fastcall virtual TALNVStringList(void)/* overload */;
	__fastcall TALNVStringList(bool OwnsObjects)/* overload */;
	__fastcall virtual ~TALNVStringList(void);
	virtual int __fastcall Add(const System::AnsiString S);
	virtual int __fastcall AddObject(const System::AnsiString S, System::TObject* AObject);
	virtual int __fastcall AddNameValue(const System::AnsiString Name, const System::AnsiString Value);
	virtual int __fastcall AddNameValueObject(const System::AnsiString Name, const System::AnsiString Value, System::TObject* AObject);
...
public:
	...
	bool Nvs;
public:
	/* TALStringKeyAVLBinaryTreeNode.Create */ inline __fastcall virtual TALAVLStringListBinaryTreeNode(void) : Alavlbinarytree::TALStringKeyAVLBinaryTreeNode() { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TALAVLStringListBinaryTreeNode(void) { }
...
public:
	__fastcall virtual TALAVLStringList(void)/* overload */;
	__fastcall TALAVLStringList(bool OwnsObjects)/* overload */;
	__fastcall virtual ~TALAVLStringList(void);
	virtual int __fastcall Add(const System::AnsiString S);
	virtual int __fastcall AddObject(const System::AnsiString S, System::TObject* AObject);
	virtual int __fastcall AddNameValue(const System::AnsiString Name, const System::AnsiString Value);
	virtual int __fastcall AddNameValueObject(const System::AnsiString Name, const System::AnsiString Value, System::TObject* AObject);
...
public:
	...
	bool Nvs;
public:
	/* TObject.Create */ inline __fastcall TALHashedStringListDictionaryNode(void) : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TALHashedStringListDictionaryNode(void) { }
...
public:
	__fastcall virtual TALHashedStringList(void)/* overload */;
	...
	__fastcall virtual ~TALHashedStringList(void);
	virtual int __fastcall Add(const System::AnsiString S);
	virtual int __fastcall AddObject(const System::AnsiString S, System::TObject* AObject);
	virtual int __fastcall AddNameValue(const System::AnsiString Name, const System::AnsiString Value);
	virtual int __fastcall AddNameValueObject(const System::AnsiString Name, const System::AnsiString Value, System::TObject* AObject);
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TALStringsEnumeratorU(void) { }
...
private:
	...
	System::UnicodeString __fastcall GetDelimitedText(void);
...
public:
	__fastcall virtual TALStringsU(void);
	__fastcall virtual ~TALStringsU(void);
	...
	virtual void __fastcall Exchange(int Index1, int Index2);
	TALStringsEnumeratorU* __fastcall GetEnumerator(void);
	...
	System::DynamicArray<System::UnicodeString> __fastcall ToStringArray(void);
	System::DynamicArray<System::TObject*> __fastcall ToObjectArray(void);
	__property int Capacity = {read=GetCapacity, write=SetCapacity, nodefault};
...
public:
	__fastcall virtual TALStringListU(void)/* overload */;
	__fastcall TALStringListU(bool OwnsObjects)/* overload */;
	__fastcall virtual ~TALStringListU(void);
	virtual int __fastcall Add(const System::UnicodeString S);
	virtual int __fastcall AddObject(const System::UnicodeString S, System::TObject* AObject);
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	virtual void __fastcall Clear(void);
...
public:
	__fastcall virtual TALNVStringListU(void)/* overload */;
	__fastcall TALNVStringListU(bool OwnsObjects)/* overload */;
	__fastcall virtual ~TALNVStringListU(void);
	virtual int __fastcall Add(const System::UnicodeString S);
	virtual int __fastcall AddObject(const System::UnicodeString S, System::TObject* AObject);
	virtual int __fastcall AddNameValue(const System::UnicodeString Name, const System::UnicodeString Value);
	virtual int __fastcall AddNameValueObject(const System::UnicodeString Name, const System::UnicodeString Value, System::TObject* AObject);

...
// (DO NOT EDIT: machine generated header) 'Alcinoe_tokyo.dpk' rev: 32.00 (Windows)

#ifndef Alcinoe_tokyoHPP
#define Alcinoe_tokyoHPP
...
namespace Alcinoe_tokyo
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Alcinoe_tokyo */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ALCINOE_TOKYO)
using namespace Alcinoe_tokyo;
#endif
#pragma pack(pop)
#pragma option pop

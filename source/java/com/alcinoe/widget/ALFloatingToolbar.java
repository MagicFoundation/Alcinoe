 ...
 */
public final class ALFloatingToolbar {
     ...
     */
    public ALFloatingToolbar(Context context, Window window) {
        this(context, window, 0);
    }

    public ALFloatingToolbar(Context context, Window window, int defStyleAttr) {
        Preconditions.checkNotNull(context);
        Preconditions.checkNotNull(window);
        mContext = applyDefaultTheme(context, defStyleAttr);
     ...
     * toolbar.
     */
    public ALFloatingToolbar setMenu(Menu menu) {
     ...
     */
    public ALFloatingToolbar setOnMenuItemClickListener(
     ...
     * toolbar.
     */
    public ALFloatingToolbar setContentRect(Rect rect) {
     ...
     * toolbar.
     */
    public ALFloatingToolbar setSuggestedWidth(int suggestedWidth) {
     ...
     */
    public ALFloatingToolbar updateLayout() {
        if (mPopup.isShowing()) {
    ...
    private static final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            mMarginHorizontal = parent.getResources()
                    .getDimensionPixelSize(R.dimen.al_floating_toolbar_horizontal_margin);
            mMarginVertical = parent.getResources()
                    .getDimensionPixelSize(R.dimen.al_floating_toolbar_vertical_margin);
        }
        ...
        public void show(Rect contentRectOnScreen) {
            ...
            LinearLayout dumyLayout = new LinearLayout(mContext); 
            mPopupWindow.showAtLocation(dumyLayout, Gravity.NO_GRAVITY, mCoordsOnWindow.x,
                    mCoordsOnWindow.y); /** showAtLocation just need a windowToken, with dumyLayout they will retrieve a null token compatible with TYPE_APPLICATION */
        ...
        private int getToolbarWidth(int suggestedWidth) {
            ...
            if (width <= 0) {
                width = mParent.getResources()
                        .getDimensionPixelSize(R.dimen.al_floating_toolbar_preferred_width);
            }
    ...
    private static final class FloatingToolbarMainPanel {
                ...
                if (menuItemButtonWidth <= availableWidth) {
                    ...
                    if (mOpenOverflowButton == null) {
                        mOpenOverflowButton = LayoutInflater.from(mContext)
                                .inflate(R.layout.al_floating_popup_open_overflow_button, null);
        ...
        private void setButtonTagAndClickListener(View menuItemButton, MenuItem menuItem) {
            ...
            if (isIconOnlyMenuItem(menuItem)) {
                button = menuItemButton.findViewById(R.id.al_floating_toolbar_menu_item_image_button);
            }
    ...
    private static final class FloatingToolbarOverflowPanel {
        ...
        public FloatingToolbarOverflowPanel(Context context, Runnable closeOverflow) {
            ...
            mBackButton = LayoutInflater.from(context)
                    .inflate(R.layout.al_floating_popup_close_overflow_button, null);
        ...
        public int getMinimumHeight() {
            return mContentView.getContext().getResources().
                    getDimensionPixelSize(R.dimen.al_floating_toolbar_minimum_overflow_height)
        ...
        private void setListViewHeight() {
            ...
            int maxHeight = mContentView.getContext().getResources().
                    getDimensionPixelSize(R.dimen.al_floating_toolbar_maximum_overflow_height);
                        ...
                        private View getIconOnlyView(int position, View convertView) {
                            ...
                            if (convertView != null) {
                                ...
                                menuButton = LayoutInflater.from(context).inflate(
                                        R.layout.al_floating_popup_overflow_image_list_item, null);
                            }
                            MenuItem menuItem = getItem(position);
                            ((ImageView) menuButton
                                    .findViewById(R.id.al_floating_toolbar_menu_item_image_button))
    ...
    private static View createMenuItemButton(Context context, MenuItem menuItem) {
        if (isIconOnlyMenuItem(menuItem)) {
            View imageMenuItemButton = LayoutInflater.from(context)
                    .inflate(R.layout.al_floating_popup_menu_image_button, null);
        ...
        Button menuItemButton = (Button) LayoutInflater.from(context)
                .inflate(R.layout.al_floating_popup_menu_button, null);
    ...
    private static TextView createOverflowMenuItemButton(Context context) {
        return (TextView) LayoutInflater.from(context)
                .inflate(R.layout.al_floating_popup_overflow_list_item, null);
    }

    private static ViewGroup createContentContainer(Context context) {
        return (ViewGroup) LayoutInflater.from(context)
                .inflate(R.layout.al_floating_popup_container, null);
    }
     ...
     */
    private static Context applyDefaultTheme(Context originalContext, int defStyleAttr) {
        TypedArray a = originalContext.obtainStyledAttributes(null, new int[]{R.attr.alfloatingToolbarStyle}, defStyleAttr, 0);
        int themeId = a.getResourceId(0, 0);
        a.recycle();
        if (themeId == 0) {
          TypedArray b = originalContext.obtainStyledAttributes(new int[]{R.attr.alfloatingToolbarStyle});
          themeId = b.getResourceId(0, 0);
          b.recycle();
          if (themeId == 0) { themeId = R.style.al_floating_toolbar_dark; }
        }
        return new ContextThemeWrapper(originalContext, themeId);
    }

    private static int getEstimatedToolbarHeight(Context context) {
        return context.getResources().getDimensionPixelSize(R.dimen.al_floating_toolbar_height);
    }

    private static int getEstimatedOpenOverflowButtonWidth(Context context) {
        return context.getResources()
                .getDimensionPixelSize(R.dimen.al_floating_toolbar_menu_button_minimum_width);
    }
}
